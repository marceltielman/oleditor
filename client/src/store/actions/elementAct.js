...
/**
  * Updates the link element identified by payload.field with the payload values
  *
  * @param {string} payload.pageId : Id of the page where the element reside
  * @param {string} payload.link : Link of the element to be updated
  * @param {string} payload.title: Title of the element to be updated
  * @param {string} payload.field: Field of the element to be updated
  *
  * @see {@link [types.updateEgglement]}
  */
