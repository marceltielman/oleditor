<template>
  <div class="menus-wrapper">
    <menu-toggle menuHeader="Custom Menu Items">
      <div class="el-menu">
        <div class="el-menu__el" :key="element.name"
          v-for="element in customEls"
          :title="element.name"
          draggable="true"
    ...
    <menu-toggle menuHeader="Basic" startClosed>
      <div class="el-menu">
        <div class="el-menu__el" :key="element.name"
    ...
    <menu-toggle menuHeader="Material Design" startClosed>
      <div class="el-menu">
...
import customElements from '@/assets/CustomElements'
